...
[Mesh]
  ...
  xmax = 1000 #X-direction domain size, for this file it is in nm
  ymax = 1000 #Y-direction domain size, for this file it is in nm
  uniform_refine = 2
[]
...
[Materials]
  ...
  [./shape_factor]
    ...
    constant_expressions = '3.141592 90'
    # function = '(2+cos(theta*pi/180))*(1-(cos(theta*pi/180))^2)/4'
    function = '1'  #homogeneous nucleation
  [../]
