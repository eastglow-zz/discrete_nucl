...
[Materials]
  ...
  [./kappa_L]
    ...
    # prop_names = 'kappa L'
    # prop_values = '24 10.0'
    prop_names =  'L0   T   length_scale time_scale eVpJ           kb            delta   Em    Ef   Ab    Bb Av  cVeq'
    prop_values = '0.1 300 1e-9         1e-12       6.24150934e+18 8.6173303e-5  0.6928  0.055 0.52 270.5 32 1000 1'
  [../]
...
[UserObjects]
  [./inserter]
    ...
    hold_time = 1e-1 #lower limit = 7.2e-5
    probability = P
    radius = r_crit
...
[MultiApps]
  [./Initial_diffusion]
    ...
    app_type = qs_void_nuclApp
    execute_on = 'INITIAL'
    positions = '0 0 0'
    input_files = ./heterogen_nucl_diff_only.i
  [../]
